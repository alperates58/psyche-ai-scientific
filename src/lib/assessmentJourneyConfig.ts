...
export const MODULE_JOURNEY_RULES: Record<string, ModuleJourneyRule> = {
  ...
  MODULE_2_SELF_IDENTITY: {
    ...
    priority: 2,
    stepNumber: 2,
    userFacingTitleTr: 'Benlik ve Kimlik Sistemi (RSES)',
  ...
  MODULE_5_GENERAL_SELF_EFFICACY: {
    classification: 'RECOMMENDED',
    priority: 3,
    stepNumber: 3,
    userFacingTitleTr: 'Genel Öz-Yeterlilik (GSE)',
    userFacingSubtitleTr: 'Başa çıkma inancı, yetkinlik ve irade dinamikleri',
    recommendationReasonTr: 'Zorlu durumlar ve engeller karşısında başa çıkma kapasitenizi analiz eder.',
    domainNameTr: 'Benlik & Yetkinlik',
  },
  MODULE_3_EMOTION_REGULATION: {
    classification: 'RECOMMENDED',
    priority: 4,
    stepNumber: 4,
    userFacingTitleTr: 'Duygu Düzenleme ve Esneklik (ERQ)',
    userFacingSubtitleTr: 'Stres yönetimi, bilişsel yeniden değerlendirme ve duygusal kontrol',
  ...
  MODULE_6_ATTACHMENT_PATTERNS: {
    classification: 'RECOMMENDED',
    priority: 5,
    stepNumber: 5,
    userFacingTitleTr: 'İlişkisel Bağlanma Örüntüleri (ECR-R)',
    userFacingSubtitleTr: 'Yakın ilişkilerde kaygı, kaçınma ve özerklik dengesi',
    recommendationReasonTr: 'Yakın ilişkilerdeki güven ve bağlanma dinamiklerinizi haritalandırır.',
    domainNameTr: 'İlişkisel Süreçler',
  },
