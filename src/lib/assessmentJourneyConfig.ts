...
export const DEFAULT_ASSESSMENT_MODULE_PORTFOLIO: ModulePortfolioItem[] = [
  // --- CORE STAGE (4 Modules, 108 Questions) ---
  {
    ...
    priority: 1,
    titleTr: 'Temel Kişilik Boyutları (HEXACO-60)',
    titleEn: 'Core Personality Dimensions (HEXACO-60)',
    subtitleTr: 'Dürüstlük-Alçakgönüllülük, Duygusallık, Dışadönüklük, Uyumluluk, Sorumluluk, Deneyime Açıklık',
    descriptionTr: 'Psikolojik profilinizin omurgasını oluşturan 6 temel faktörü ve 24 alt boyutu ölçer.',
    rationaleTr: 'Tüm psikolojik analizin temel referans çerçevesidir.',
  ...
  },
  {
    ...
    classification: 'REQUIRED',
    priority: 2,
    titleTr: 'Benlik Sistemi ve Öz-Yetkinlik (RSES & GSE)',
    titleEn: 'Self-System & Generalized Agency (RSES & GSE)',
  ...
  },
  {
    ...
    descriptionTr: 'Duygusal deneyimleri dönüştürme ve ifade etme tarzlarınızı 2 bağımsız eksende değerlendirir.',
  ...
  },
  {
    ...
    classification: 'REQUIRED',
    priority: 4,
    titleTr: 'Bilişsel ve Epistemik Yönelim (NFC & Epistemic Curiosity)',
    titleEn: 'Cognitive & Epistemic Orientation (NFC & Epistemic Curiosity)',
  ...
  // --- EXPANSION STAGE (4 Modules, 157 Questions, Cumulative: 265) ---
  {
    ...
    priority: 5,
    titleTr: 'İrade, Öz-Kontrol ve Dürtüsellik (BSCS & UPPS-P Short)',
    titleEn: 'Volition, Self-Control & Impulsivity (BSCS & UPPS-P Short)',
  ...
  },
  {
    ...
    classification: 'RECOMMENDED',
    priority: 6,
    titleTr: 'Temel Psikolojik İhtiyaçlar (BPNSFS)',
    titleEn: 'Basic Psychological Needs Satisfaction & Frustration (BPNSFS)',
  ...
  },
  {
    ...
    classification: 'RECOMMENDED',
    priority: 7,
    titleTr: 'Evrensel İnsani Değerler (PVQ-RR Short)',
    titleEn: 'Universal Human Values (PVQ-RR Short)',
  ...
  },
  {
    ...
    classification: 'RECOMMENDED',
    priority: 8,
    titleTr: 'İlişkisel Bağlanma ve Empati (ECR-R & IRI)',
    titleEn: 'Relational Attachment & Empathy (ECR-R & IRI)',
  ...
  // --- DEEP STAGE (7 Modules, 166 Questions, Cumulative: 431) ---
  {
    ...
    priority: 9,
    titleTr: 'Bilişsel Esneklik ve Belirsizlik Yönetimi (CFI & IUS-12)',
    titleEn: 'Cognitive Adaptability & Uncertainty Management (CFI & IUS-12)',
  ...
  },
  {
    ...
    classification: 'OPTIONAL',
    priority: 10,
    titleTr: 'Varoluşsal Anlam, Öz-Şefkat ve Sebat (MLQ, SCS-SF & Grit-S)',
    titleEn: 'Existential Meaning, Self-Compassion & Grit (MLQ, SCS-SF & Grit-S)',
    subtitleTr: 'Yaşamda Anlam, Öz-Şefkat Boyutları ve Uzun Vadeli Sebat',
    descriptionTr: 'Yaşam amacı algınızı, kendinize karşı nazik olma yetinizi ve tutkulu sebatınızı birleştirir.',
  ...
  },
  {
    ...
    classification: 'OPTIONAL',
    priority: 11,
    titleTr: 'Çatışma Yönetimi ve Kişisel Sınırlar (DUTCH-20)',
    titleEn: 'Conflict Resolution Styles & Boundaries (DUTCH-20)',
    subtitleTr: 'İşbirliği, Uzlaşma, Kaçınma ve Sağlıklı Sınır Koyma',
    descriptionTr: 'Fikir ayrılıklarında başvurduğunuz müzakere tarzlarını ve kişisel sınır koyma netliğinizi haritalandırır.',
  ...
  },
  {
    ...
    classification: 'OPTIONAL',
    priority: 12,
    titleTr: 'Duygulanım Dengesi ve Sıkıntı Toleransı (PANAS & DTS)',
    titleEn: 'Affective Tone & Distress Tolerance (PANAS & DTS)',
    subtitleTr: 'Pozitif/Negatif Duygulanım ve Yoğun Duygu Toleransı',
    descriptionTr: 'Gündelik duygu tonusunuzu ve stres anında dağılmadan kalabilme eşiğinizi analiz eder.',
  ...
  },
  {
    ...
    classification: 'OPTIONAL',
    priority: 13,
    titleTr: 'Psikolojik İyilik ve Canlılık (FS & SWLS)',
    titleEn: 'Psychological Flourishing & Life Satisfaction (FS & SWLS)',
    subtitleTr: 'Bütünsel İyilik Hali ve Yaşam Doyumu',
    descriptionTr: 'Yaşamınızdaki çiçek açma (flourishing) düzeyini ve global yaşam doyumunuzu ölçer.',
  ...
  },
  {
    ...
    classification: 'OPTIONAL',
    priority: 14,
    titleTr: 'Başa Çıkma Stratejileri ve Dayanıklılık (Brief-COPE & BRS)',
    titleEn: 'Coping Strategies & Stress Resilience (Brief-COPE & BRS)',
    subtitleTr: 'Problem/Duygu Odaklı Başa Çıkma ve Psikolojik Toparlanma Gücü',
    descriptionTr: 'Kriz ve stres anlarında devreye soktuğunuz aktif başa çıkma repertuarını ve toparlanma hızınızı inceler.',
  ...
  },
  {
    ...
    classification: 'OPTIONAL',
    priority: 15,
    titleTr: 'Yaratıcı Zihniyet ve Epistemik Merak (5DCR & Mindset)',
    titleEn: 'Creative Mindset & Epistemic Curiosity (5DCR & Mindset)',
    subtitleTr: 'Neşeli Keşif, Yoksunluk Duyarlılığı ve Yaratıcı Öz-İnanç',
    descriptionTr: 'Yaratıcı düşünceye olan güveninizi ve zihinsel keşif merakınızı haritalandırır.',
  ...
  // --- ADVANCED STAGE (1 Module, 28 Questions, Cumulative Total: 459) ---
  {
    ...
    priority: 16,
    titleTr: 'Karanlık Dörtlü ve Uç Kişilik Eğilimleri (SD4)',
    titleEn: 'Short Dark Tetrad Personality Dimensions (SD4)',
    subtitleTr: 'Makyavelizm, Narsisizm, Psikopati ve Sadizm Eğilimleri',
    descriptionTr: 'Sosyal ilişkilerde stratejik güç, empati eksikliği ve sertlik boyutlarını subklinik düzeyde analiz eder.',
