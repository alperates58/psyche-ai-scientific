    ...
    <div className="space-y-8 pb-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
        ...
        <div className="lg:col-span-7 bg-surface-1 p-6 rounded-card border border-border-subtle shadow-xs">
          ...
          <div className="mt-4 pt-4 border-t border-border-subtle grid grid-cols-3 sm:grid-cols-6 gap-2 text-center">
            {displayTraits.map((t) => (
      ...
      <div className="bg-surface-1 p-5 rounded-panel border border-border-subtle shadow-xs flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="flex items-start space-x-3.5">
          <div className="w-9 h-9 rounded-xl bg-brand-50 border border-brand-200 flex items-center justify-center text-brand-700 flex-shrink-0 mt-0.5">
        ...
        <Link
          href="/council"
          className="inline-flex items-center justify-center px-4 py-2 rounded-xl border border-border-default hover:bg-surface-2 text-xs font-semibold text-text-secondary transition-colors whitespace-nowrap"
        >
