...
export default function ResearchLoginPage() {
  ...
  return (
    <div className="min-h-[70vh] flex flex-col justify-center items-center px-4">
      <div className="w-full max-w-md bg-surface-1 p-8 rounded-card border border-border-subtle shadow-md space-y-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full px-3.5 py-2.5 rounded-xl border border-border-strong bg-surface-2 text-text-primary text-sm focus:outline-none focus:ring-2 focus:ring-brand-500/20 focus:border-brand-500 transition-all placeholder:text-text-tertiary"
            />
          </div>
          ...
          <button
            ...
            className="w-full inline-flex justify-center items-center px-4 py-2.5 text-xs font-semibold rounded-xl bg-brand-600 text-white hover:bg-brand-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-xs"
          >
            {isLoading ? (
